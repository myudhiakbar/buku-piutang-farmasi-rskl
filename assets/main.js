...
links.forEach((link) => {
	...
	if (linkPage === currentPage) {
		link.classList.add("border-b-2", "border-blue-600", "pb-1");
		link.classList.remove("hover:text-blue-800");
	}
});
...
loanForm.onsubmit = (e) => {
	...
	Swal.fire({
		...
		text: "Data akan disimpan di server",
		icon: "question",
		showCancelButton: true,
